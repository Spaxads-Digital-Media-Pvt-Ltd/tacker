              ...
              <table className="premium-table">
                <thead>
                  <tr>
                    ...
                    {shown.has('Click to Event Rate') && <th className="text-right font-semibold">Click to Event Rate</th>}
                    {shown.has('Invalid Clicks %') && <th className="text-right font-semibold">Invalid Clicks %</th>}
